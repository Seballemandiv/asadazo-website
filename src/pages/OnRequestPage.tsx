  ...
  return (
    <div className="page container">
      ...
      <p style={{ marginTop: 0, marginBottom: 16, opacity: 0.9 }}>
        ...
        We will source it and provide you with an update within 24–48 hours.
      </p>
      <form className="card" onSubmit={onSubmit}>
        <input name="cut" placeholder="Cut name" value={values.cut} onChange={onChange} required
        ...
        <input name="email" type="email" placeholder="Email" value={values.email} onChange={onChange} required
          style={{ padding: '0.75rem', borderRadius: 8, border: '1px solid rgba(233,205,155,.35)', background: 'rgba(122,51,38,.12)', color: 'inherit', width: '100%' }} />
        <div style={{ height: 8 }} />
        <textarea name="notes" placeholder="Notes (optional)" value={values.notes} onChange={onChange} rows={5}
